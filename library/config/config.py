...
USERS_AND_QUANTITY_HEADERS = ('ID', 'Nickname', 'Status', 'Online', 'Quantity of library')
FOOD_TYPES = ('salad', 'first_course', 'main_course', 'soup', 'drink', 'dessert')